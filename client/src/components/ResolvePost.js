...
export default class ResolvePost extends Component {
  ...
  uploadReply = () => {
    ...
    axios.post('http://ec2-13-58-142-212.us-east-2.compute.amazonaws.com:8000/complain/reply', {
  ...
  markResolved = () => {
    axios.post('http://ec2-13-58-142-212.us-east-2.compute.amazonaws.com:8000/complain/mark-resolved', { _id: this.props._id })
      .then(() => {
        this.props.populateComplaints();
      })
      .catch(err => {
