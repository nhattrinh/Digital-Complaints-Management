...
const callback_url = process.env.ENDPOINT_URL || "http://ec2-18-223-122-143.us-east-2.compute.amazonaws.com";
...
router.get('/auth/google/callback',
  ...
  async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`http://ec2-18-223-122-143.us-east-2.compute.amazonaws.com/?id=${sub}&new=${query === null ? 'true' : 'false'}`);
    }
    catch (err) {
      console.log(err);
